...
const playercountEmbed = async (interaction) => {
    const initialEmbed = new EmbedBuilder()
        ...
        .setFooter({
            "text": "Vous avez 30 secondes pour choisir le nombre de joueurs.",
        });
...
const werewolfEmbed = (playerCount) => {
    const responseEmbed = new EmbedBuilder()
        ...
        .setFooter({
            "text": "Vous avez 30 secondes pour choisir le nombre de Loup-Garous.",
        });
...
const roleEmbed = (playerCount, werewolfCount) => {
    const responseEmbed = new EmbedBuilder()
        ...
        .setFooter({
            "text": "Vous avez 30 secondes pour choisir les roles.",
        });
