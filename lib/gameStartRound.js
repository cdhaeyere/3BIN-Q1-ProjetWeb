...
const gameStartRound = async (playerList, channelGeneral, loverList, thiefRoles, channels) => {
    ...
    return new Promise(async (resolve) => {
        if (thiefRoles.includes(Roles.WEREWOLF)) {
            const embed = new EmbedBuilder()
                ...
                .setDescription(`Vu qu'une des deux cartes est un Loup vous êtes désormais un Loup`)
