...
const thiefActions = async (thief, playerList, channelThief) => {
    return new Promise(async (resolve) => {
        ...
        await channelThief.send({content: `<@${thief.player.id}>`, embeds: [embed], components: [row]});
...
const cupidActions = async (cupid, playerList, channelCupid, loverList) => {
    return new Promise(async (resolve) => {
        ...
        await channelCupid.send({content: `<@${cupid.player.id}>`, embeds: [embed], components: [row]});
